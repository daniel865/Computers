 ...
 */
public class ServletCreateComputer extends javax.servlet.http.HttpServlet {
    ...
    protected void doPost(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, IOException {
        ...
        try {
            computersDAO.createComputer(new Computer(null, serial, model, networkName, idUser,
                    userName, idManufacturer, nameManufacturer));
        }catch (Exception e){
